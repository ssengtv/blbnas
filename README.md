...
<div align="center">
  <img src="public/logo.png" alt="BlbTV Logo" width="120">
</div>

> 🎬 **BlbTV** 是一个开箱即用的、跨平台的影视聚合播放器。它基于 **Next.js 14** + **Tailwind&nbsp;CSS** + **TypeScript** 构建，支持多资源搜索、在线播放、收藏同步、播放记录、云端存储，让你可以随时随地畅享海量免费影视内容。
...
services:
  BlbTV-core:
    ...
    environment:
      ...
      - KVROCKS_URL=redis://BlbTV-kvrocks:6666
    networks:
      - BlbTV-network
    depends_on:
      - BlbTV-kvrocks
...
services:
  BlbTV-core:
    ...
    environment:
      ...
      - REDIS_URL=redis://BlbTV-redis:6379
    networks:
      - BlbTV-network
    depends_on:
      - BlbTV-redis
...
| NEXT_PUBLIC_SITE_NAME               | 站点名称                                     | 任意字符串                       | BlbTV                                                                                                                     |
...
[MIT](LICENSE) © 2025 BlbTV & Contributors
